...
$query = $bdd->prepare('SELECT DISTINCT nom ,price,description,image,type FROM produit WHERE nom LIKE ?');
$query->execute(array(''.$prod.'%'));
?>
<html>
<head>
    ...
    echo "
          ...
          <div class='cart-grid' id='cart-1'>
            ...
            <div class='snipcart-details '>
                ...
                <button onclick=window.location.href='".$row['type'].".php' name='add' class='button w3l-cart' data-id='cart-1'>Quick view</button>
            </div>
          </div>
