...
<div class="banner">
      ...
      <div class="container">
        <div class="top-grid">
          <div class="cart-grid" id="cart-1">
            <div class="img">
              <img src="images/fortnite.jpg" alt="img">
            </div>
            <ul class="info">
              <h5>50-100 random skins/pickaxes</h5>
              <li>$4.99</li>
              <li class="right-text">$9.99</li>
            </ul>
            <div class="snipcart-details ">
              <form action="index.php" method="post">
                ...
                <input type="hidden" name="item_name" value="50-100-random-skins/pickaxes" />
          ...
          <div class="cart-grid" id="cart-2">
            ...
            <ul class="info">
              <h5>30-50 random skins/pickaxes</h5>
              <li>$0.75</li>
              <li class="right-text">$1.00</li>
            </ul>
            <div class="snipcart-details ">
              <form action="index.php" method="post">
                <input type="hidden" name="cmd" value="_cart">
                ...
                <input type="hidden" name="item_name" value="30-50-random-skins/pickaxes" />
                <button type="submit"name="add" class="button w3l-cart" name="add" data-id="cart-3">add to cart</button>
              </form>
            </div>
          </div>
          <div class="cart-grid" id="cart-3">
            ...
            <ul class="info">
              <h5>10-30 random skins/pickaxes</h5>
              <li>$0.25</li>
              <li class="right-text">$0.35</li>
            </ul>
            <div class="snipcart-details ">
              <form action="index.php" method="post">
                <input type="hidden" name="cmd" value="_cart">
                ...
                <input type="hidden" name="item_name" value="10-30-random-skins/pickaxes" />
  ...
  <!-- //cart's-Product-Display -->
    <div class="wthreecartaits wthreecartaits2 cart cart box_1">
      <form action="../../cart/mycart.php" method="post" class="last">
        <input type="hidden" name="cmd" value="_cart" />
