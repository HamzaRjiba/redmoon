...
<div class="row-fluid">
    ...
    <div class="col-md-5" id="rightSection">
        ...
        <ol>
            ...
            <li>
             Include this script tag- <pre><code>&lt;script src="https://www.paypal.com/sdk/js?client-id=sb"&gt;&lt;/script&gt;</code></pre>
            </li>
            <li>
...
<!-- Javascript Import -->
<script src="https://www.paypal.com/sdk/js?client-id=sb&commit=true"></script>
